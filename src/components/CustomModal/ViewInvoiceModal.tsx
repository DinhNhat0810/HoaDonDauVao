...
function ViewInvoiceModal({
  ...
  return (
    <Modal open={open} onCancel={handleCancel} footer={null} width={1600}>
      <div className="flex mt-10 justify-between">
        <div className="w-1/2">
          <div id="aloha" className=""></div>
        </div>
        <div className="flex-1 flex justify-center bg-white ">
          <div className="flex flex-col items-start justify-between gap-4 relative  shadow-custom p-4 py-6">
              ...
              <div className="flex flex-col items-start gap-3 px-4 py-3 relative self-stretch w-full flex-[0_0_auto] border-t [border-top-style:solid] border-neutral-200">
                ...
                <div className="flex flex-col items-start gap-1 relative self-stretch w-full flex-[0_0_auto]">
                  ...
                  <div className="flex items-center relative self-stretch w-full flex-[0_0_auto]">
                    ...
                    <div className="flex-1 ml-10  relative w-fit mt-[-1.00px] font-semibold text-neutral-800 text-sm tracking-[0] leading-5 whitespace-nowrap">
                      từ{" "}
                      {dayjs(data?.cksNguoiBanObj?.NotBefore).format(
                        "DD/MM/YYYY"
                      )}{" "}
                      đến{" "}
                      {dayjs(data?.cksNguoiBanObj?.NotAfter).format(
                        "DD/MM/YYYY"
                      )}
                    </div>
                  </div>
